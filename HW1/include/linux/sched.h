...
/* journalling filesystem info */
	...
	int hw1_proc_restriction_level;
    scr* hw1_restrictions_list;
    int hw1_list_size;
    fai* hw1_logs_array;
    int hw1_logs_array_size;
    int hw1_curr_log_index;
};
...
{									\
    ...
    journal_info:	NULL,						\
    hw1_proc_restriction_level: -1,			\
    hw1_restrictions_list: NULL,				\
    hw1_list_size: -1,					\
    hw1_logs_array: NULL,                  \
    hw1_logs_array_size: -1,             \
    hw1_curr_log_index: -1              \
}
